...
export const dataES = {
  ...
  profile: "Senior AI Engineer especializado en soluciones de IA Generativa en producción: agentes LLM, RAG y prototipos funcionales construidos mano a mano con negocio, con Claude (Anthropic) y OpenAI para clientes como BBVA, Iberia o Telefónica. Base full stack sólida — Python, FastAPI, Django, React y TypeScript — y desarrollo asistido por IA en el día a día (Claude Code, Copilot). Certificado por Anthropic: Claude Code, Claude, MCP, Bedrock y Vertex AI.",
  contact: {
