...
export const dataES = {
  ...
  profile: "Senior AI Engineer con ownership de punta a punta: agentes y copilotos LLM en producción — RAG, tool use, orquestación multi-agente y MCP — para clientes enterprise (BBVA, Iberia, Telefónica), cubriendo todo el stack desde Python/FastAPI y PostgreSQL hasta React/TypeScript, con Docker y CI/CD en Azure y GCP. El desarrollo agéntico es mi flujo diario (Claude Code); certificado por Anthropic en Claude, MCP, Bedrock y Vertex AI.",
  contact: {
  ...
  skills: {
    ...
    ai_devops: ["Agentes LLM: RAG · tool use · multi-agente", "MCP (Model Context Protocol)", "Claude (Anthropic) · OpenAI · LangChain", "Desarrollo agéntico (Claude Code)", "Evaluación y observabilidad de LLMs", "Azure AI · GCP Vertex · AWS Bedrock", "Docker · CI/CD · MLOps"],
...
export const dataEN = {
  name: "VÍCTOR TRISAC",
  title: "Senior AI Engineer | Full Stack Developer",
  profile: "Senior AI Engineer who ships end to end: production LLM agents and copilots — RAG, tool use, multi-agent orchestration and MCP — for enterprise clients (BBVA, Iberia, Telefónica), owning the full stack from Python/FastAPI and PostgreSQL to React/TypeScript, with Docker and CI/CD on Azure and GCP. Agentic development is my daily workflow (Claude Code); Anthropic-certified in Claude, MCP, Bedrock and Vertex AI.",
  contact: {
    phone: "+34 663 769 539",
    email: "victorperez694@gmail.com",
  ...
  skills: {
    ...
    frontend: ["React.js", "TypeScript", "Vue.js", "Tailwind CSS"],
    ai_devops: ["LLM agents: RAG · tool use · multi-agent", "MCP (Model Context Protocol)", "Claude (Anthropic) · OpenAI · LangChain", "Agentic development (Claude Code)", "LLM evaluation & observability", "Azure AI · GCP Vertex · AWS Bedrock", "Docker · CI/CD · MLOps"],
    databases: ["PostgreSQL", "SQL Server", "MySQL", "MariaDB", "MongoDB"]
  },
