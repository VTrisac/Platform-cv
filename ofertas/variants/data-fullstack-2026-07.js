...
export const dataES = {
  name: "VÍCTOR TRISAC",
  title: "Full Stack Developer | Python · React · IA",
  profile: "Full Stack Developer con 4 años construyendo aplicaciones web de negocio de punta a punta: backends en Python (FastAPI, Django) con APIs REST, frontends en React y TypeScript, bases de datos SQL (PostgreSQL, SQL Server, MySQL) y despliegue con Docker y CI/CD en Azure y GCP. Además, integro IA generativa en producto (agentes LLM, RAG) para clientes como BBVA, Iberia y Telefónica. Certificado por Anthropic.",
  contact: {
...
export const dataEN = {
  name: "VÍCTOR TRISAC",
  title: "Full Stack Developer | Python · React · AI",
  profile: "Full Stack Developer with 4 years building business web applications end to end: Python backends (FastAPI, Django) with REST APIs, React and TypeScript frontends, SQL databases (PostgreSQL, SQL Server, MySQL), and Docker/CI-CD deployments on Azure and GCP. I also integrate generative AI into products (LLM agents, RAG) for clients like BBVA, Iberia and Telefónica. Anthropic-certified.",
  contact: {
    phone: "+34 663 769 539",
    email: "victorperez694@gmail.com",
