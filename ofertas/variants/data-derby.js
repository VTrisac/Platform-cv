// Variante tailored: Derby Hotels Collection — IA Developer / AI Engineer (ofertas/2026-07-14-derby-hotels-ia-developer.md)
...
export const dataES = {
  ...
  profile: "AI Engineer especializado en IA generativa y automatización de procesos de negocio con Python, Azure y GCP. Diseño asistentes virtuales, copilotos LLM y automatizaciones inteligentes integrados con sistemas corporativos (ERP), con pipelines de datos y monitorización en producción. Experiencia previa en el sector hotelero desarrollando herramientas de gestión interna. Tecnología que simplifica, automatiza y genera valor de negocio.",
  contact: {
  ...
  experience: [
    {
      ...
      achievements: [
        "Construcción de asistentes virtuales y copilotos LLM en producción sobre Claude, integrando RAG, tool use y orquestación multi-agente.",
      ...
      tech: ["Python", "Claude (Anthropic)", "OpenAI", "RAG", "Azure AI", "GCP Vertex", "FastAPI", "LangChain", "Docker"]
    },
    {
      project: "EASO MAGNO",
      ...
      tech: ["Python", "n8n", "OpenAI", "FastAPI", "Docker", "Azure", "GCP"]
    },
    {
      project: "Kauai",
    ...
    },
    {
      ...
      achievements: [
        "Desarrollo de herramientas de gestión interna para la eficiencia operativa del grupo hotelero.",
  ...
  skills: {
    ...
    ai_devops: ["OpenAI API", "GCP/Azure", "n8n (Automatización)", "Docker", "CI/CD"],
...
export const dataEN = {
  name: "VÍCTOR TRISAC",
  title: "AI Engineer | Full Stack Developer",
  profile: "AI Engineer specialized in generative AI and business process automation with Python, Azure, and GCP. I design virtual assistants, LLM copilots, and intelligent automations integrated with corporate systems (ERP), with data pipelines and production monitoring. Previous experience in the hotel sector building internal management tools. Technology that simplifies, automates, and delivers business value.",
  contact: {
    phone: "+34 663 769 539",
    email: "victorperez694@gmail.com",
  ...
  experience: [
    {
      ...
      achievements: [
        "Built production virtual assistants and LLM copilots on Claude — RAG, tool use, and multi-agent orchestration.",
    ...
    },
    {
      ...
      achievements: [
        "Development of internal management tools for the hotel group's operational efficiency.",
  ...
  skills: {
    ...
    frontend: ["Vue.js", "React.js", "TypeScript", "Tailwind CSS"],
    ai_devops: ["OpenAI API", "GCP/Azure", "n8n (Automation)", "Docker", "CI/CD"],
    databases: ["PostgreSQL", "SQL Server", "MySQL", "MariaDB", "MongoDB"]
  },
