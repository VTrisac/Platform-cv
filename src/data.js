export const dataES = {
  ...
  profile: "Senior AI Engineer y Full Stack Developer especializado en Python, FastAPI, Vue.js y automatización con IA generativa. Diseño sistemas escalables que conectan datos, automatizan procesos y mejoran la eficiencia real de los equipos. Desde ERPs personalizados hasta agentes y copilotos LLM con Claude, OpenAI e integraciones en Azure y GCP. Mi filosofía: tecnología que simplifica, automatiza y crece contigo.",
  contact: {
  ...
  skills: {
    ...
    ai_devops: ["n8n (Automatización)", "OpenAI API", "Docker", "GCP/Azure", "CI/CD"],
...
export const dataEN = {
  name: "VÍCTOR TRISAC",
  title: "Senior AI Engineer | Full Stack Developer",
  profile: "Senior AI Engineer and Full Stack Developer specialized in Python, FastAPI, Vue.js, and generative AI automation. I design scalable systems that connect data, automate processes, and improve real team efficiency. From custom ERPs to LLM agents and copilots powered by Claude, OpenAI, and integrations on Azure and GCP. My philosophy: technology that simplifies, automates, and grows with you.",
  contact: {
    phone: "+34 663 769 539",
    email: "victorperez694@gmail.com",
  ...
  skills: {
    ...
    frontend: ["Vue.js", "React.js", "TypeScript", "Tailwind CSS"],
    ai_devops: ["n8n (Automation)", "OpenAI API", "Docker", "GCP/Azure", "CI/CD"],
    databases: ["PostgreSQL", "SQL Server", "MySQL", "MariaDB", "MongoDB"]
  },
